 ...
 */
public class custommovie extends BaseAdapter {
    ...
    Context context;
    public custommovie(Context context,ArrayList<databaseinfo> list){
        this.arrlist=list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        contactView=inflater.inflate(R.layout.moviegridlayout,null);
